...
När användaren fyller i bokningsformuläret för att boka en bana
Så får användaren information på hemsidan att bokning är genomförd

-------------------------------------------------------------------------------------------------------

Feature: Dropdown meny för aktiviter
...
När användaren hovrar med muspekaren över dropdown menyn
Så ser användaren alla aktiviteter som finns tillgängliga på sportcenter
